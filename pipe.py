...
class Pipe:
    def __init__(self,scale_factor,move_speed,):
        self.img_up=pg.transform.scale_by(pg.image.load("sfx/pipeup.png").convert_alpha(),scale_factor)
        self.img_down=pg.transform.scale_by(pg.image.load("sfx/pipedown.png").convert_alpha(),scale_factor)
